...
An [AngularJS](http://angularjs.org) project for friendly sports viewing with pals.

***

## Quick Start: dev

`file:///path/to/ng-boilerplate/build/index.html` in your browser.

## Roadmap

### To Do
Admin:
   - Create initial form module:
     + field for prop name
     + field for passing criteria (o/u)
       * saves to list of props
       * ability to edit
       * inputs for outcomes
User Input
   - form contents output to list
   - add checkbox for less than
   - add checkbox for greater than
   - add submit button
...
When you're ready to push into production, run the `compile`
command:
